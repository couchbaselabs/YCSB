...
final class ArraySchemaColumn implements SchemaColumn {
    final String name;
    final SchemaColumnType arrayElementType;
    ArraySchemaColumn(String name, SchemaColumnType arrayElementType) {
        this.name = name;
