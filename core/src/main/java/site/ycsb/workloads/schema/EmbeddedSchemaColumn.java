...
final class EmbeddedSchemaColumn implements SchemaColumn {
    final String name;
    final List<SchemaColumn> elements;
    EmbeddedSchemaColumn(String name, List<SchemaColumn> elements) {
        this.name = name;
    ...
    public SchemaColumnKind getColumnKind() {
        return SchemaColumnKind.NESTED;
    }
    @Override
